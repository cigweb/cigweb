      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {services.map((service, index) => (
            <motion.div
              key={index}
              className="group bg-gradient-to-br from-gray-800/60 to-gray-900/60 rounded-2xl p-8 backdrop-blur-sm border border-gray-600/30 hover:border-blue-400 transition-all duration-300"
            ...
            >
              <motion.div 
                className="bg-gradient-to-br from-gray-700/50 to-gray-800/50 rounded-xl p-4 w-fit mb-6 group-hover:from-blue-600/30 group-hover:to-green-600/30 transition-all duration-300"
        ...
        >
          ...
          >
            <Link
              to="/iletisim"
              className="inline-flex items-center bg-gradient-to-r from-blue-600 to-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-500 hover:to-green-500 transition-all duration-300 shadow-lg hover:shadow-xl border border-blue-400/50"
            >
              Bugün Başlayın
            </Link>
          </motion.div>
